...
Color scheme: [KDE material you colors](https://github.com/luisbocanegra/kde-material-you-colors) (the transparency of konsole is from this too)

Blur effects: [Better Blur dx](https://github.com/xarblu/kwin-effects-better-blur-dx)
